...
public:
    ...
    /// <param name="allAvailable">If set, the method returns a complete history of statuses/commands. (optional, default to false)</param>
    ...
    pplx::task<std::vector<std::shared_ptr<Message>>> listCommands(
        ...
        boost::optional<bool> allAvailable,

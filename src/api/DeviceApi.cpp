...
pplx::task<std::vector<std::shared_ptr<Message>>> DeviceApi::listCommands(utility::string_t companyName, utility::string_t carName, utility::string_t sdeviceId, boost::optional<utility::string_t> allAvailable, boost::optional<int32_t> until, boost::optional<utility::string_t> wait) const
{


    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/command/{company_name}/{car_name}/{sdevice_id}");
    ...
    boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("sdevice_id") + utility::conversions::to_string_t("}"), web::uri::encode_uri(ApiClient::parameterToString(sdeviceId)));
...
pplx::task<std::vector<std::shared_ptr<Message>>> DeviceApi::listStatuses(utility::string_t companyName, utility::string_t carName, utility::string_t sdeviceId, boost::optional<utility::string_t> allAvailable, boost::optional<int32_t> since, boost::optional<utility::string_t> wait) const
{


    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/status/{company_name}/{car_name}/{sdevice_id}");
    boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("company_name") + utility::conversions::to_string_t("}"), web::uri::encode_uri(ApiClient::parameterToString(companyName)));
    boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("car_name") + utility::conversions::to_string_t("}"), web::uri::encode_uri(ApiClient::parameterToString(carName)));
    boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("sdevice_id") + utility::conversions::to_string_t("}"), web::uri::encode_uri(ApiClient::parameterToString(sdeviceId)));
...
pplx::task<void> DeviceApi::sendCommands(utility::string_t companyName, utility::string_t carName, utility::string_t sdeviceId, boost::optional<std::vector<std::shared_ptr<Message>>> message) const
{
...
pplx::task<void> DeviceApi::sendStatuses(utility::string_t companyName, utility::string_t carName, utility::string_t sdeviceId, boost::optional<std::vector<std::shared_ptr<Message>>> message) const
{
